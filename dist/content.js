...
function setHistory(id, state) {
  let historybox = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`div.preview[id='${id}']`).find("button.historybox");
  if (state)
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(historybox).attr("class", "follow-unfollow historybox following");
  else jquery__WEBPACK_IMPORTED_MODULE_0___default()(historybox).attr("class", "follow-unfollow historybox");
}
...
function boxClicked(event) {
  const id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target)
    .parents("div")
    .attr("id");
...
function fillFrame(event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".preview-frame").html(""); // clear all iframes

  let $preview = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target)
  ...
  if (previewOpen) {
    let $checkbox = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target)
      .parents(`[id='${id}']`)
      .find(".historybox");
...
function generatePreview(id, idType) {
  let $button = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<button>")
    .attr("title", "load preview player")
    .attr("type", "button")
    .attr("class", "follow-unfollow open-iframe")
    .attr("style", "width: 90%");

  let $preview = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>").html("Preview");
  $button.append($preview);

  let $checkbox = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<button>")
  ...
  $preview = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>")
    .attr("class", "preview-frame")
    .attr("id", `${idType}-${id}`);

  let $parent = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>")
    .attr("id", id)
    .attr("class", "preview")
    .append($button)
    .append($checkbox)
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("li.music-grid-item[data-item-id]").each(function(index, item) {
    const idAndType = jquery__WEBPACK_IMPORTED_MODULE_0___default()(item)
      .closest("li")
      .attr("data-item-id");
    const id = idAndType.split("-")[1];
    const idType = idAndType.split("-")[0];
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(item).append($preview);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(item).show();

    port.postMessage({ query: id });
  });

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('li.music-grid-item[data-tralbumid][data-tralbumtype="a"]').each(function(
    index,
    item
  ) {
    const id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(item).attr("data-tralbumid");
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#pagedata")
    .first()
    .each(function(index, item) {
      const datablob = JSON.parse(jquery__WEBPACK_IMPORTED_MODULE_0___default()(item).attr("data-blob"));
      try {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".open-iframe").on("click", function(event) {
    fillFrame(event);
    previewClicked(event);
  });

  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".historybox").on("click", function(event) {
    boxClicked(event);
  });
});
